...
@class OLEContainerScrollView, LDPageContainerScrollView;

@protocol OLEContainerScrollViewDelegate <NSObject>
...
@property (nonatomic, weak) id<OLEContainerScrollViewDelegate> scrollDelegate;
@property (nonatomic, strong, readonly) LDPageContainerScrollView *pageContainerScrollView;

@property (nonatomic, assign) BOOL isNeedRefresh;
/**
 The topMargin of the segControl when it's floating. Default is 0.
*/
@property (nonatomic, assign) CGFloat segControlFloatingTopMargin;
@property (nonatomic, assign, readonly) BOOL pullDownToReload;
